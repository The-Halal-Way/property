  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final page = await tester.runAsync(
        () => BaseClientPropertyRemoteDataSource(context).fetchProperties(),
      );

      expect(
        adapter.request.uri.toString(),
        '${MyApiUrl.baseUrl}/${MyApiUrl.version}/${MyApiUrl.properties}',
      );
...
class _PropertyAdapter implements HttpClientAdapter {
